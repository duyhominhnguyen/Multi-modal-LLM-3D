...
def main():
    ...
    # parser.add_argument("--batch_size_laion", type=int, default=128)  # Commented out
    ...
    # parser.add_argument("--loss_multiplier_laion", type=float, default=1.0)  # Commented out
    ...
    # parser.add_argument("--train_num_samples_laion", type=int, default=10000)  # Commented out
    ...
    #     args.laion_shards = f"pipe:aws s3 cp {args.laion_shards} -"  # Commented out
    ...
    # Commented out the assertion for LAION and MMC4 sample equality
    ...
    # laion_dataset = get_data(args, image_processor, tokenizer, "image_text")  # Commented out
    ...
    for epoch in tqdm(range(resume_from_epoch, args.num_epochs)):
        # laion_dataset.set_epoch(epoch)  # Commented out
        # laion_loader = laion_dataset.dataloader  # Commented out
        ...
        train_one_epoch(
            ...
            # laion_loader=laion_loader,  # Commented out
